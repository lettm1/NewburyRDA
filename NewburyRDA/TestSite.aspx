...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .box {
          ...
          margin-top: 0px;
          padding: 0% 20px 5% 20px; /* Added a percentage value for top/bottom padding to keep the wrapper inside of the parent */
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div  style="background-color: whitesmoke; padding: 5% 0px 20px 0px"></div>
    ...
    <div class="box">
        ...
        <div id="autumnfair" class="row" style="cursor: pointer; background-color: whitesmoke; padding-top: 0px; padding-bottom: 20px">
            <div class="col-md-12 " align="center" style="padding: 0px">
                <div class="jumborestoff">
                    ...
                    <br />
                    <a style="font-family: 'Bree Serif', serif;color:grey; font-size: 28px;" href="AutumnGiftFair.aspx">Autumn Fair - click for details!...</a>
                    <div style="height: 10px;"></div>
                </div>
                <marquee scrollamount="15" behavior="scroll" direction="left">
                   <p style="margin:0px;color: red;font-weight:bold">DO NOT MISS our AUTUMN FAIR on 28 September 2017 with 50+ quality stalls - start your Christmas shopping early!</p>
                </marquee>
                <br />
                <br />
        ...
        <div id="News" class="row" style="background-color: white; padding: 0px 0px 0px 0px">
            <div class="col-12 " align="center" style="padding: 20px">
                <a class="" style="font-family: 'Bree Serif', serif;color:grey; font-size: 24px;" href="LatestNews.aspx">
                    <img class="border" src="img/news.png" style="width: 120px" />
                    <br />
                    News...
                </a>
                <div style="height: 10px;"></div>
                <p>New Pony Joins the Team!</p>
        ...
        <div id="Events" class="row" style="background-color: #whitesmoke; padding: 30px 0px 30px 0px">
            <div class="col-12 " align="center" style="cursor: pointer;">
                <a style="font-family: 'Bree Serif', serif;color:grey; font-size: 24px;" href="Events.aspx">
        ...
        <div id="Ponies" class="row" style="background-color: white; padding: 30px 0px 30px 0px">
            <div class="col-12 " align="center" style="cursor: pointer; padding: 20px">
                <a style="font-family: 'Bree Serif', serif;color:grey; font-size: 24px;" href="Ponies.aspx">
                    <img src="img/kiss2.jpg" style="width: 150px" />
                    <br />
                    Ponies...</a>
                <br />
                <div style="height: 10px;"></div>
                <p>The ponies are the tools of our work.  We depend on them, we couldn't operate without them and it is the ponies who the children love.  They do a magnificent job and bring great happiness and benefit to the children.</p>
            </div>
        </div>
    ...
    <div class="box3">
        ...
        <div id="Contact" class="row" style="background-color: whitesmoke; padding: 30px 0px 30px 0px">
        ...
        <div id="Volunteer" class="row" style="padding: 30px 20px 0px 20px">
            <div class="col-12 col-sm-4 " align="center" style="padding:20px;background-color: white; cursor: pointer;">
                <div style="background-color:#3E8817;border-radius:20px; padding:20px;height:220px;" >
                <a style="font-family: 'Bree Serif', serif;color:white; font-size: 16px;" href="VolunteerInfo.aspx">
            ...
            <div class="col-12 col-sm-4 " align="center" style="padding:20px;background-color: white; cursor: pointer;">
                <div style="background-color:#3E8817;border-radius:20px; padding:20px;height:220px;" >
                <a style="font-family: 'Bree Serif', serif;color:white; font-size: 16px;" href="Support.aspx">
            ...
            <div class="col-12 col-sm-4 " align="center" style="padding:20px;background-color: white; cursor: pointer;">
                <div style="background-color:#3E8817;border-radius:20px; padding:20px;height:220px;" >
                <a style="font-family: 'Bree Serif', serif;color:white; font-size: 16px;" href="fundraising.aspx">
    ...
    <div class="box2">
        ...
        <div class="row" style="background-color: whitesmoke; padding: 0px 0px 30px 0px">
            <div class="col-12 " align="center" style=" cursor: pointer; padding: 0px">
                <a style="font-family: 'Bree Serif', serif;color:grey; font-size: 24px;" href="FAQ.aspx">
        ...
        <div class="row" style="background-color: white; padding: 80px 0px 80px 0px">
            <div class="col-md-12" align="center" style="padding: 0px">
                <a style="font-family: 'Bree Serif', serif;color:grey; font-size: 24px;" href=" https://www.facebook.com/newburyrda1/">
