<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AutumnGiftFair.aspx.cs" Inherits="NewburyRDA.AutmnGiftFair" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row " style="background-color:white;text-align: left">    <div class="row" style="background-color:white;">
        <div class="col-md-12">
            <div class="row" style="background-color:white;">
                <div class="col-md-12">
