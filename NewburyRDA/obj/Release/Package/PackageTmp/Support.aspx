<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Support.aspx.cs" Inherits="NewburyRDA.Support" %>
    ...
    <div class="row" style="background-color: white">
        <div class="col-md-12" style="padding: 0px">
            <div class=" " style="margin-bottom: 10px">
                <br />
                <h1 class="hidden-sm-down" style="font-weight: normal; text-align: center">Support</h1>
                <h4 class="hidden-md-up" style="font-weight: normal; text-align: center"><strong>Support</strong></h4>
            </div>
        </div>
    </div>
    <div class="row" style="background-color: white">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="background-color: white; margin-bottom: 10px; text-align: left">
                        <div style="margin: 10px">




                            <div style="width: 100%; height: 100%; margin: 10px; padding: 15px; text-align: left">

                                <h2 class="hidden-sm-down" style="font-weight: normal; text-align: left">We are always grateful for any support</h2>
                                <h5 class="hidden-md-up" style="font-weight: normal; text-align: left"><strong>We are always grateful for any support.</strong></h5>
