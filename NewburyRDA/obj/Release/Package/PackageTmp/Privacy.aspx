<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Privacy.aspx.cs" Inherits="NewburyRDA.Privacy" %>
    ...
    <div class="row" style="padding:0px;margin:40px 0px 40px 0px" >
        <div class="col-md-12" style="padding:0px" >
            <div class="animated flipInX"  style="margin-bottom: 10px">
                <br />
                <h1 class= "hidden-sm-down" style="font-weight: normal;text-align:center">Privacy</h1>
                <h4 class= "hidden-md-up" style="font-weight: normal;text-align:center"><strong>Privacy</strong></h4>
            </div>
        </div>
    </div>
        <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card" style="margin-bottom: 10px">
                        <div style="margin: 10px">
                            ...
                            <h3>(1)	This privacy policy</h3>

                            <p>This privacy policy was made using an SEQ Legal privacy policy template created for http://www.employmentlawcontracts.co.uk.  </p>
                            ...
                            <p>(h)	send to you marketing communications relating to our business which we think may be of interest to you by post or, where you have specifically agreed to this, by email or similar technology (you can inform us at any time if you no longer require marketing communications);  </p>

                            <p>(j)	deal with enquiries and complaints made by or about you relating to the website;   </p>

                            <p>(k)	your information will not be shared with third parties or other companyies.  </p>
                            ...
                            <p>
                                If you have any questions about this privacy policy or our treatment of your personal information, please write to us by email to info@NewburyRDA.co.uk or by post to Newbury RDA, Newbury RDA, Wyld Court Stud, Hampstead Norreys, RG18 0TN
                            </p>

                            <h3>(11)	Data controller  </h3>

                            <p>
                                The data controller responsible in respect of the information collected on this website is Newbury RDA. 
                            </p>
