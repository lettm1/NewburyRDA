<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="Spencer.aspx.cs" Inherits="NewburyRDA.Spencer" %>
    ...
    <div class="row" style="background-color: white">
        <div class="col-md-12" style="padding: 0px">
            <div class=" " style="margin-bottom: 10px">
                <br />
                <h1 class="hidden-sm-down" style="color:red;font-weight: normal; text-align: center">AUDIENCE WITH SPENCER WILTON</h1>
                <h4 class="hidden-md-up" style="color:red;font-weight: normal; text-align: center"><strong>AUDIENCE WITH SPENCER WILTON</strong></h4>
            </div>
        </div>
    </div>
