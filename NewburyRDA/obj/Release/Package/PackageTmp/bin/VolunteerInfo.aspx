<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VolunteerInfo.aspx.cs" Inherits="NewburyRDA.VolunteerInfo" %>
    ...
    <div class="row" style="background-color:white" >
        <div class="col-md-12" style="padding:0px" >
            <div class="animated flipInX"  style="margin-bottom: 10px">
                <br />
                <h1 class= "hidden-sm-down" style="font-weight: normal;text-align:center">Volunteer Information</h1>
                <h4 class= "hidden-md-up" style="font-weight: normal;text-align:center"><strong>Volunteer Information</strong></h4>
            </div>
        </div>
    </div>
    <div class="row" style="background-color:white">
